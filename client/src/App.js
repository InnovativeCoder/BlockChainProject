...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Get your DUMM tokens now</h1>
        <p>Grab the tokens right now!</p>
        <h2>KYC Whitelisting</h2>
        Address to allow: Address to allow:{" "}
        <input
          type="text"
          name="kycAddress"
        ...
        <h2>Buy Tokens</h2>
        <p>
          If you wanna buy tokens send Wai to this address:{" "}
          {this.state.tokenSaleAddress}
        </p>
        <p>You currently have: {this.state.userTokens} DUMM tokens</p>
